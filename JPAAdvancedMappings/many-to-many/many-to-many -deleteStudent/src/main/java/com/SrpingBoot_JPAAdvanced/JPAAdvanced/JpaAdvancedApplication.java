...
public class JpaAdvancedApplication {
	...
	private void deleteStudent(AppDAO appDAO) {
		...
		System.out.println("hurray Student deleting is completed");
	}

	private void deleteCourse(AppDAO appDAO) {
		int theId=12;
		System.out.println("the Deleted Course id is:"+theId);
	    appDAO.deleteCourseById(theId);
		System.out.println("hurray Course deleting is completed");
